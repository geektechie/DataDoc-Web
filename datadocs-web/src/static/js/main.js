...
require.config({
  ...
  shim: {
    ...
    'angular-dropdown-multiselect': { deps: ['angular'] },
    'angular-sanitize': { deps: ['angular'] },
    'angular-clipboard': { deps: ['angular'] },
    'angular-elastic-input': { deps: ['angular'] },
    'angular-svg-round-progressbar': { deps: ['angular'] },
    'ui-codemirror': {
    ...
    'codemirror/addon/custom/bnf': { deps: ['codemirror/addon/mode/simple'] },
    'gapi': { exports: 'gapi' },
    'google-drive-upload': { exports: 'MediaUploader' },
    'jquery': { exports: '$' },
    'jquery-ui': { exports: '$', deps: ['jquery'] },
    'jquery-actual': { deps: ['jquery'] },
    'angular-sortable-view': { deps: ['angular'] },
    'angular-ui-select': { deps: ['angular'] },
    'json-formatter': { deps: ['angular'] },
    'moment-duration-format': { deps: ['moment'] },
    'numericInput': { deps: ['jquery'] },
    'angular-cron-jobs': { deps: ['angular'] },
    'ocLazyLoad': { deps: ['angular'] },
    'ocLazyLoad-uiRouterDecorator': { deps: ['ocLazyLoad'] },
    'tag-context-menu': { deps: ['angular'] },
    'KeyJS': { exports: "KeyJS" }
  }
});

require([ 'angular', 'bluebird', 'app' ], function (ng, bluebird) {
  'use strict';

  // TODO: make as part of build process, get rid of this for modern browsers
  window.Promise = bluebird;
  ng.bootstrap(document, ['app'], { strictDi: true });
});
