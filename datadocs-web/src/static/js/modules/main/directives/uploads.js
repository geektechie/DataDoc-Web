define(['./module', 'common', 'notifications-utils', 'lodash'], function (directives, common, NotificationsUtils, _) {
    'use strict';
                ...
                link: function ($scope, $elm, $attr) {
                    ...
                    $scope.uploader.onSuccessItem = async function(item, descriptor){
                        ...
                        post.then(data => {
                            ...
                            if(error.status == 400){
                                NotificationsUtils.notifyError({
                                    message: 'Unfortunately, we do not yet support highly nested JSON objects. Please try uploading another file type.'
                                })
                                return;
                            }
                        });
