...
define([
  ...
  return angular.module('app', [
    ...
    $provide.factory('httpRequestInterceptor',['$q','$window','$rootScope',function ($q, $window,$rootScope){

      var notifierOpened = false;

      function notifyError (rejection){
        if(rejection.status === 401 && rejection.config.url != api_base_url + "/api/auth/login" && !notifierOpened){
  ...
  function($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, $locationProvider, $provide) {
    ...
    if(!isEmbed){
      ...
      $stateProvider
        .state('auth', {
          ...
          omitAuth: true,
          resolve: {
            loggedInUser: ['User', '$rootScope',function(User,$rootScope){
                $rootScope.loggedInUser = User.getCurrent() && User.getCurrent().email? User.getCurrent(): undefined;
                return {};
            }]
          }
        })
        ...
        .state('auth.auth-with-google-account', {
          url: "/auth-with-google-account?token",
          controller: "authWithGoogleAccountCtrl",
          templateUrl: "/static/templates/auth/auth-with-google-account.html",
          omitAuth: true
        })
        .state('auth.billing', {
            url: "/billing",
            controller: "billingCtrl",
            templateUrl: "/static/templates/billing/billing.html",
            omitAuth: true,
            resolve: {
                        loggedInUser: ['User', '$rootScope',function(User,$rootScope){
                            $rootScope.loggedInUser = User.getCurrent();
                            return {};
                        }]
                      }
        })
            ...
            deps: ['$lazyLoader', '$templateRequest', '$q', '$sce',
              ...
              function ($lazyLoader, $templateRequest, $q, $sce,
                ...
                var templates = [
                  ...
                  { path: '/static/templates/main/team-members.html' },
                  { path: '/static/templates/main/search.html' },
                  { path: '/static/templates/main/my-account.html' },
                  { path: '/static/templates/main/billing-history.html' }
                ];
        ...
        .state('main.landing.team_members', {
          url: 'team-members',
          templateUrl: '/static/templates/main/team-members.html'
        })
        ...
        .state('main.landing.my_account', {
          url: 'my-account',
          templateUrl: '/static/templates/main/my-account.html',
          controller: 'myAccountCtrl'
        })

        .state('main.landing.billing_history', {
          url: 'billing-history',
          templateUrl: '/static/templates/main/billing-history.html',
      ...
      $stateProvider
        ...
        $rootScope.bseUrl = "http://localhost:8000";
    ...
    $rootScope.$on('$stateChangeStart',
      function(event, toState, toParams, fromState){
        ...
        else if (User.isSignedIn() && toState.name === 'main.landing.team_members') {
